...
const AdPlacement = ( {
    ...
    ( <svg
        className = { buildClassName( className, cssMap,
            {
                showBelow     : belowIsShown,
                lowerSelected : belowIsSelected,
                upperSelected : aboveIsSelected,
        ...
        <g
            ...
            <g
                ...
                fillRule = "nonzero">
                <g
                    className = { cssMap.upperContent }
                    transform = "translate(27.000000, 22.000000)"
                    fillRule = "nonzero" >
                    <rect className = { cssMap.contentBackground } x = "0" y = "0" width = "212" height = "120" />
                    <rect className = { cssMap.rectanglePath } x = "8" y = "9" width = "196" height = "34" />
                    <rect className = { cssMap.rectanglePath } x = "8" y = "49" width = "170" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "98" y = "70" width = "106" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "98" y = "87" width = "50" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "98" y = "98" width = "50" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "98" y = "109" width = "50" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "154" y = "87" width = "50" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "154" y = "98" width = "50" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "154" y = "109" width = "50" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "8" y = "70" width = "84" height = "44" />
                </g>
                <g
                    className = { cssMap.lowerContent }
                    transform = "translate(27.000000, 151.000000)"
                    fillRule = "nonzero" >
                    <rect className = { cssMap.contentBackground } x = "0" y = "-7" width = "212" height = "60" />
                    <rect className = { cssMap.rectanglePath } x = "8" y = "0" width = "196" height = "5" />
                    <rect className = { cssMap.rectanglePath } x = "8" y = "22" width = "196" height = "23" />
                    <rect className = { cssMap.rectanglePath } x = "8" y = "11" width = "163" height = "5" />
                </g>
            </g>
        ...
        <rect
            onMouseOver = { onMouseOverTrigger }
...
AdPlacement.propTypes =
{
     ...
     */
    onMouseOverTrigger : PropTypes.func
};
